$(document).ready(function () {
    ...
    var cThemeName = "Oski-docs-selected-theme";
    ...
    if (user) {
        ...
        else $('#imgUserPhoto').attr("src", "https://secure.gravatar.com/avatar/" + MD5(split[4]) + "?s=40&d=" + escape("https://portal.Oski.com/styles/images/human.png"));
        ...
        $("#lnkMyAccount").click(function () {
            window.location = "https://portal.Oski.com/" + that.account + "/accounts.html?accounts=myaccount";
        });

        $("#lnkApps").click(function () {
            window.location = "https://portal.Oski.com/" + that.account + "/app-list.html";
        });
    ...
    $("#btnLogin").click(function(e){
        e.preventDefault();
        window.location = 'https://portal.Oski.com/login.html?rel=devcenter'+ '&ru=' + window.location.href;
        return false;
    });
